...
public class DataTableReducerContext {
  ...
  private final int _maxWindowResultRows;
  ...
  public DataTableReducerContext(ExecutorService executorService, int maxReduceThreadsPerQuery, long reduceTimeOutMs,
      int groupByTrimThreshold, int maxWindowResultRows) {
    ...
    _maxWindowResultRows = maxWindowResultRows;
  }
  ...
  public int getMaxWindowResultRows() {
    return _maxWindowResultRows;
  }
}
